...
class LoggingMiddleware(BaseHTTPMiddleware): #로그를 콘솔에 출력하는 용도 1개의 사용위치
...
#          파이선 백엔드 가동서버로 main.py에 app이라는 메서드를 사용
#                           갱신        포트번호 변경 8001